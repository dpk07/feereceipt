...
require 'classes/mysqlstaff.php';
...
class membership{
      ...
      {
            $mysql = New mysqlstaff();
            $ensure_credentials = $mysql->verify_un_pw($un, $pwd);
...
<html>
<head>
	<title>Fee Receipt - StaffLogin</title>
	<meta charset="utf-8">
	...
	<div class="container-fluid box">
		<div class="col-md-4 col-md-offset-4 loginbox">
			<div class="panel-heading  loginheader">
                <div class="panel-title">Staff Log In</div>
            </div>
            <br>
            <form method="post" action="">
            	...
            	<div class="input-group">
            		...
            		<input id="login-password" type="password" class="form-control" name="pwd" required="" placeholder="Password" ">
            	</div>
            	<br>
            	<div class="input-group">
            		<div class="checkbox">
